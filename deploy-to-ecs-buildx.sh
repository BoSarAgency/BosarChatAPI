...
echo "🚀 Starting deployment of BoSar API to ECS with buildx..."
...
# Build and push the Docker image for AMD64 platform using buildx
echo "🏗️  Building and pushing Docker image for AMD64 platform..."
docker buildx build \
